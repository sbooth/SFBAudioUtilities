...
#pragma mark Property Operations
	...
	template <typename T, typename std::enable_if_t<std::is_trivial_v<T>, bool> = true>
	...
	template <typename T, typename std::enable_if_t</*std::is_class_v<T> &&*/ std::is_pointer_v<T>, bool> = true>
